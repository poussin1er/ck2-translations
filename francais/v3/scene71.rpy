...
translate francais v3s71_c15001d0:
    ...
    de "Bonjour. J'apprécie que vous soyez à l'heure."
...
translate francais v3s71_02f5b1d8:
    ...
    de "Tout ce dont vous avez besoin se trouve ici. J'ai aussi acheté de nouveaux jouets pour qu'Oscar puisse jouer avec."

# game/v3/scene71.rpy:50
translate francais v3s71_95a890d5:

    # de "I need to leave for my meeting now, so."
    de "Je dois partir pour ma réunion maintenant, alors..."

# game/v3/scene71.rpy:55
translate francais v3s71_33e01dbf:

    # de "Thanks again for helping. I'll be back in an hour or so."
    de "Merci encore pour votre aide. Je serai de retour dans une heure ou deux."
...
translate francais v3s71_3362a70c:
    ...
    de "Oh, et s'il vous plaît, nourrissez-le avant que je ne revienne."
...
translate francais v3s71_83d1ea0b:
    ...
    de "S'il ne mange pas une fois par heure, c'est lui qui prend les choses en main. *Soupir*"
...
translate francais v3s71_3dcbab1e:
    ...
    pe "Haha, bien. Ne vous inquiétez pas."
...
translate francais v3s71_0f8d57b6:
    ...
    u "T'es dans ce fauteuil depuis deux secondes et le pouvoir t'est déjà monté à la tête."
...
translate francais v3s71_36af0093:
    ...
    u "*Rire* Wow, t'es pire que Harrison !"
...
translate francais v3s71_09e79957:
    ...
    pe "Je l'ai croisée un jour en rentrant, et elle avait Oscar."
...
translate francais v3s71_54bc4875:
    ...
    pe "Elle a remarqué qu'il ne me détestait pas, je pense, et a demandé si je pouvais passer de temps en temps pour voir comment il allait."
...
translate francais v3s71_d71fe31b:
    ...
    pe "Je pouvais pas dire non ! C'est préférable de rester dans ses petits papiers, tu crois pas ?"
...
translate francais v3s71_8714a56b:
    ...
    pe "Haha, c'est tout à fait ça. Bien que... Ce qu'elle ne sait pas ne lui fera pas de mal."
...
translate francais v3s71_0960e224:
    ...
    pe "Tu vois, on n'a pas eu l'occasion de faire quoi que ce soit d'amusant hier soir, avant de s'endormir..."
...
translate francais v3s71_e120638e:
    ...
    pe "Alors, on va faire quelque chose, ici."
...
translate francais v3s71_sg_c7d1b373:
    ...
    pe "Oh. On dirait qu'il n'était pas fan..."
...
translate francais v3s71_sg_45dd42d1:
    ...
    u "Tout dépend du point de vue. Il a peut-être un peu trop aimé ça. *Rire*"
...
translate francais v3s71_sg_edef75c1:
    ...
    u "C'est meilleur que ce qu'ils servent à la cafétéria, ça c'est sûr."
...
translate francais v3s71_sg_4af371bf:
    ...
    u "Et maintenant, c'est l'heure de la sieste. *Soupirs* Moi aussi, j'aimerais pouvoir jouer, manger et dormir toute la journée."
...
translate francais v3s71_sg_d5a3569e:
    ...
    pe "Haha. Il a la vie facile maintenant qu'il a trouvé une bonne propriétaire."
...
translate francais v3s71_sg_3b5e54e0:
    ...
    u "(Mais putain, qu'a fait Elijah ?)"
