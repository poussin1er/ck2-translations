...
translate francais v3s25_79e312a2:
    ...
    u "(Amber peut-elle avoir une relation avec quelqu'un ? C'est vraiment une chose à laquelle il faut réfléchir.)"
...
translate francais v3s25_85c022c5:
    ...
    u "(J'ai jamais imaginé qu'Amber serait du genre à avoir une relation sérieuse. Peut-être que les choses ont changé.)"
...
translate francais v3s25_98947775:
    ...
    u "(Surtout quand on sait qu'au départ, j'aurais pu l'empêcher d'obtenir ce boulot.) *Soupirs*"
...
translate francais v3s25_67b988f0:
    ...
    u "(Si quelqu'un peut supporter d'être harcelée par des connards tous les soirs, c'est bien Amber.)"

# game/v3/scene25.rpy:86
translate francais v3s25_303894c4:

    # u "(I'm glad she's happy.)"
    u "(Je suis content qu'elle soit heureuse.)"

# game/v3/scene25.rpy:127
translate francais v3s25_sg_31dd048b:

    # u "You love these late-night sessions, huh?"
    u "T'aimes bien ces sessions de fin de soirée, hein ?"
...
translate francais v3s25_sg_b4c8009b:
    ...
    em "Haha, c'est vrai. Je ne peux pas m'empêcher de penser à toi tous les soirs en me mettant nue et en m'installant confortablement."
...
translate francais v3s25_sg_b1cd4e46:
    ...
    u "( Merde, bien sûr qu'il est verrouillé. Hum, essayons...)"
...
translate francais v3s25_sg_f3cd002a:
    ...
    u "(Haha, trop fort. J'ai réussi ! Les mecs, sont si prévisibles que ça ?)"
...
translate francais v3s25_sg_016da1e3:
    ...
    u "Ça devrait être bon. Tu m'entends ?"
...
translate francais v3s25_sg_c5598e45:
    ...
    u "Ouais, j'aime bien celui-là. Il met vraiment ton corps en valeur."

# game/v3/scene25.rpy:500
translate francais v3s25_sg_ea4f8ba3:

    # em "Yeah? Does it?"
    em "Ah oui ? C'est vrai ?"
...
translate francais v3s25_sg_4f4ab4a8:
    ...
    u "(Je devrais ramener cet ordinateur portable avant d'oublier. Et après, au pieu !)"

# game/v3/scene25.rpy:663
translate francais v3s25_sg_cea9c18d:

    # u "I'm super tired right now, Emily. Can we do this another time?"
    u "Je suis vraiment fatigué là, Emily. On peut faire ça un autre jour ?"
...
translate francais strings:
    ...
    old "Find a laptop"
    new "Trouver un ordinateur"

    # game/v3/scene25.rpy:185
    old "I'm too tired"
    new "Je suis trop fatigué"
