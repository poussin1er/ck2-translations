...
translate francais v3s70_b_6d0f48a1:
    ...
    pe "Hé, merci d'être venu. Je n'étais pas trop sûre de pouvoir gérer ça toute seule."

# game/v3/scene70.rpy:40
translate francais v3s70_b_c2c042e5:

    # u "He's a chill dog. Like, a stoner almost."
    u "C'est un chien tranquille. Genre, un drogué ou presque."
...
translate francais v3s70_b_61cdffe9:
    ...
    pe "Super. Je suis content qu'on soit sur la même longueur d'onde, maintenant. *Ricane*"
