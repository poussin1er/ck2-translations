...
translate francais v3s64_b_b6528037:
    ...
    cl "Comment était le massage, Lindsey ?"
...
translate francais v3s64_b_6e1752c4:
    ...
    li "Incroyable. Un peu brutal à certains moments mais hé, j'aime que ce soit rude parfois, haha."
...
translate francais v3s64_continue_9b1cec89:
    ...
    cl "Sortez les chamallows. J'ai tout ce dont nous avons besoin pour faire des chamallows grillés."
...
translate francais v3s64_continue_0e19059a:
    ...
    u "Merci ! J'adore les chamallows."
...
translate francais v3s64_continue_e4e3d7ce:
    ...
    u "Non, merci. Je suis pas d'humeur."
...
translate francais v3s64_continue_409a6319:
    ...
    au "T'es pas d'humeur à manger des chamallows au feu de camp ? T'es fou ?"
...
translate francais v3s64_continue_ba23ec25:
    ...
    u "Non, je suis juste un peu plein, mais merci de t'en inquiéter. *Rire*"
...
translate francais v3s64_continue_f2922ff9:
    ...
    u "*Rire* Waouh, combien pensez-vous qu'on puisse en mettre là-dessus ?"

# game/v3/scene64.rpy:127
translate francais v3s64_continue_8e7c2e89:

    # au "*Muffled* Wanna find out?"
    au "*Étouffé* Tu veux l'savoir ?"
...
translate francais v3s64_continue_969e45d1:
    ...
    cl "Je reconnais ton écriture non féminine, [name]."
...
translate francais v3s64_continue_9cb7764b:
    ...
    u "Franchement, j'ai juste cru que ça serait drôle, je voulais pas faire de mal."
...
translate francais v3s64_continue_1c39af35:
    ...
    cl "Eh ben, c'est pas drôle ! C'est vraiment pas drôle du tout."
...
translate francais v3s64_continue_090dd5fe:
    ...
    u "Je suis désolé, sérieux ! C'était une petite blague, je te le jure."
...
translate francais v3s64_continue_7f529d93:
    ...
    cl "*Soupirs* Parfois, je ne te reconnais pas, [name]. Tu as un drôle de sens de l'humour."
...
translate francais v3s64_continue_939279c4:
    ...
    cl "Si tu crois que je trouverais les insultes anonymes amusantes, alors je devrais peut-être revoir les choses entre nous."
...
translate francais v3s64_continue_ea5f4450:
    ...
    u "( Bon, j'ai merdé.) Je m'excuse, Chloé. C'était une très mauvaise idée, et t'as le droit d'être en colère contre moi, et j'espère que tu pourras me pardonner très vite."

# game/v3/scene64.rpy:291
translate francais v3s64_continue_858ab65f:

    # no "Ahem! Well, if you ask me..."
    no "Hum ! Eh bien, si tu me demandes..."

# game/v3/scene64.rpy:296
translate francais v3s64_continue_2f76566f:

    # jen "Pretty sure no one did."
    jen "Je suis quasiment sûre que personne a fait ça."
...
translate francais v3s64_continue_89086a90:
    ...
    no "Ceci étant dit... Vas-y, Chloé. Tu sais bien qu'il voulait pas te blesser."
...
translate francais v3s64_continue_8d860d0a:
    ...
    jen "C'est vrai ! On t'aurait pas embrassé pendant une heure si t'étais pas un véritable canon !"
...
translate francais v3s64_continue_4bc94ba9:
    ...
    cl "*Rire* Merci. Je me sens un peu mieux à ce sujet."
...
translate francais v3s64_continue_07a9dbdd:
    ...
    cl "Oh ! [name], merci. Tu es gentil d'avoir ajouté quelque chose de mignon."

# game/v3/scene64.rpy:386
translate francais v3s64_continue_e9a763b0:

    # u "Wait! How'd you know it was me?!"
    u "Attends ! Comment t'as su que c'était moi ?!"
...
translate francais v3s64_continue_b9f7c270:
    ...
    u "Je crois que c'est le bon moment pour que je parte et que votre vraie fête commence, haha."

# game/v3/scene64.rpy:441
translate francais v3s64_continue_bd10a599:

    # li "Finally! No boys, no boys, no boys!"
    li "Enfin ! Plus de garçons, plus de garçons, plus de garçons !"
...
translate francais v3s64_continue_8d489029:
    ...
    u "Merde. Les filles, vous êtes sûres de pas avoir besoin d'un mec grand, beau et fort pour rester avec vous toute la nuit ?"
...
translate francais v3s64_continue_fc3e5349:
    ...
    # u "(I wanna get wild...)"
    u "(Moi aussi, je veux devenir sauvage...)"
...
translate francais v3s64_continue_b6de8bbc:
    ...
    li "Oh, Polly se produit sur le campus, au fait. Je dois donc y aller un peu, mais je reviens pour les films."
...
translate francais v3s64_continue_a240d1c0:
    ...
    li "Merci pour la soirée spa, Chloé. Je me suis vraiment bien amusée, bizarrement. *Rire*"
...
translate francais v3s64_continue_3154f7c1:
    ...
    li "Je sais, je sais ! Je suis juste trop fan de Polly pour rater ça."
...
translate francais v3s64_continue_211aa343:
    ...
    u "Passez une bonne soirée, mesdemoiselles ! Vous savez comment me joindre en cas d'urgence."

# game/v3/scene64.rpy:512
translate francais v3s64_continue_a96b72f6:

    # jen "Leave already so we can talk about you!"
    jen "Va-t'en déjà ! Qu'on puisse enfin parler de toi !"
...
translate francais v3s64_continue_376c4542:
    ...
    li "Attends une seconde, [name]. Je vais d'abord me changer, attends là !"
