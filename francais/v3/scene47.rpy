...
translate francais v3s47_53003558:
    ...
    cl "Saluuuuut ! Bienvenue dans la maison de la parentalité forcée..."

# game/v3/scene47.rpy:23
translate francais v3s47_d248fee9:

    # u "*Laughs* It's not that bad."
    u "*Rire* C'est pas si terrible."
...
translate francais v3s47_4c1d8e0c:
    ...
    u "Oh là là, ta mère est déjà devenue folle et a oublié que tu étais en plastique. *Rire*"
