...
translate francais v3s15_9dd1b2e9:
    ...
    u "Eh bien, bonjour, jeune fille. Avez-vous besoin de compagnie ?"
...
translate francais v3s15_64eb1e6d:
    ...
    u "Alors, où sont les tourtereaux ?"
...
translate francais v3s15pier_carousel_d4ea9925:
    ...
    pe "Je veux avoir l'un des chevaux ! Les banquettes, c'est pour les bébés. *Rire*"
...
translate francais v3s15pier_carousel_564e9fd2:
    ...
    u "C'est un carrousel, Pénélope. Tout le truc est plus ou moins pour les bébés, haha."
...
translate francais v3s15pier_carousel_ef4c7d55:
    ...
    pe "Je sais ! Tu n'as qu'à faire comme si ça allait super vite !"
...
translate francais v3s15pier_carousel_a08b6186:
    ...
    u "Allez, ils peuvent pas le faire aller plus vite ?"
...
translate francais v3s15pier_carousel_e198bdec:
    ...
    carni "Avant, ça allait beaucoup plus vite, mais y a une vieille dame qui s'est cassé la hanche."
...
translate francais v3s15pier_carousel_fba0b28f:
    ...
    carni "Alors j'crois qu'tu devrais être plus respectueux avec le mec qui tient ta putain d'vie entre ses mains !"

# game/v3/scene15.rpy:312
translate francais v3s15pier_carousel_52a37bcc:

    # u "(Holy shit, dude... There are kids here.)"
    u "(Ferme ta gueule, mec... Y a des enfants ici.)"
...
translate francais v3s15pier_carousel_4720e7f6:
    ...
    carni "En plus, elle nous a fait un procès pour réclamer plein d'fric, donc maintenant, on a plus l'droit d'accélérer l'manège."

# game/v3/scene15.rpy:325
translate francais v3s15pier_carousel_2d1bc347:

    # u "Oh, um, alright, Well, thanks for letting us know."
    u "Oh, euh, d'accord, Eh ben, merci de nous avoir raconté tout ça."
...
translate francais v3s15pier_carousel_640ceb47:
    ...
    carni "Pas d'quoi. On r'çoit beaucoup d'plaintes sur la lenteur de c'manège, mais tu dois savoir qu'j'essaie juste de t'garder en sécurité !"
...
translate francais v3s15pier_carousel_af995f1f:
    ...
    pe "*Soupirs* Cette nuit-là était incroyable. J'y pense encore très souvent..."
...
translate francais v3s15pier_carousel_689e0ecb:
    ...
    u "Ah, rester à rien faire et fantasmer sur moi ? C'est ce que tu fais en ce moment ?"

# game/v3/scene15.rpy:439
translate francais v3s15pier_carousel_14abf4d7:

    # pe "I didn't say that was all I was doing..."
    pe "J'ai pas dit que je ne faisais rien..."
...
translate francais v3s15pier_carousel_5200f811:
    ...
    u "*Soupirs* Tu me racontes des cochonneries, Pénélope ? *Rire*"
...
translate francais v3s15pier_carousel_1131dc5a:
    ...
    u "Désolé, j'arrive plus à trouver de sous-entendus, là, haha."
...
translate francais v3s15pier_carousel_b640e519:
    ...
    pe "Ça va être un parcours intéressant !"
...
translate francais v3s15pier_carousel_f6fdc9f5:
    ...
    carni "Accrochez-vous bien ! C'est part-"
...
translate francais v3s15pier_carousel_e3f55e32:
    ...
    carni "Vous pouvez pas faire ça ! Vous pouvez pas monter à deux d'sus. On a des limites de poids pour ces ch'vaux."

# game/v3/scene15.rpy:509
translate francais v3s15pier_carousel_78cfee7b:

    # u "Seriously? A weight limit?"
    u "Sérieux ? Une limite de poids ?"
...
translate francais v3s15pier_carousel_753cb336:
    ...
    carni "Ouaip. Descendez et allez sur un siège, si vous voulez vous met' ensemble."
...
translate francais v3s15pier_carousel_1b3ebfbc:
    ...
    carni "On a des règles de sécurité pour une bonne raison ! Vous voyez pas qu'j'essaie d'vous protéger ?!"
...
translate francais v3s15pier_carousel_c828eb78:
    ...
    carni "J'suis un opérateur d'carrousel. J'dois faire respecter les règles de sécurité."
...
translate francais v3s15pier_carousel_3259a6cb:
    ...
    carni "J'dois vous garder en sécurité, même si vous m'crachez d'ssus, que vous me gueulez d'ssus ou que vous vous foutez d'ma gueule. C'est le serment qu'j'ai fait."
...
translate francais v3s15pier_carousel_fca70513:
    ...
    carni "Alors, détestez-moi si vous voulez. Mais j'laisserai AUCUN danger vous tomber d'ssus."

# game/v3/scene15.rpy:549
translate francais v3s15pier_carousel_4e7909b8:

    # u "Whoa, okay. Hey man, we're getting off, see?"
    u "Whoa, ok. Hé mec, on descend, tu vois ?"
...
translate francais v3s15pier_carousel_e94bbf42:
    ...
    u "Oh, j'ai pas encore demandé. Comment t'as réussi à te faire embarquer, pour venir avec ces deux là ?"
...
translate francais v3s15pier_carousel_184e8b27:
    ...
    u "C'est un peu bizarre qu'elle t'ait invité à son rencard, non ?"
...
translate francais v3s15pier_carousel_69c5bed5:
    ...
    u "C'est vrai. On peut pas tout comprendre de Imre en une seule fois."
...
translate francais v3s15pier_carousel_940c1802:
    ...
    carni "Et on fait attention en descendant et en sortant du manège. Si quelqu'un a été blessé, il doit aller à la tente de premiers secours."

# game/v3/scene15.rpy:655
translate francais v3s15pier_carousel_1f4b84fa:

    # carni "I refuse to let anyone die on my watch."
    carni "J'veux pas laisser quelqu'un mourir sous ma responsabilité."

# game/v3/scene15.rpy:660
translate francais v3s15pier_carousel_8f0d3c8d:

    # u "We're good man, thanks."
    u "Tout va bien mec, merci."
...
translate francais v3s15pier_wheel_0a82bd4b:
    ...
    dy "Laisse tomber c'truc ! Elle est carrément truquée ta roue, ma vieille !"

# game/v3/scene15.rpy:708
translate francais v3s15pier_wheel_087420ff:

    # pe "He sounded upset."
    pe "Il avait l'air énervé."
...
translate francais v3s15pier_wheel_a3b1bb90:
    ...
    u "Ouais, il doit avoir raison, mais ça fait partie des plaisirs du carnaval, non ?"

# game/v3/scene15.rpy:718
translate francais v3s15pier_wheel_b6ee7212:

    # pe "Getting scammed?"
    pe "De se faire arnaquer ?"
...
translate francais v3s15pier_wheel_415e4399:
    ...
    imre "C'est bon, tout va bien. Les microbes peuvent pas s'attacher aux bonbons durs. C'est scientifique."

# game/v3/scene15.rpy:808
translate francais v3s15pier_wheel_6e486b67:

    # dg3 "What? Who told you that?"
    dg3 "Quoi ? Qui t'a dit ça ?"
...
translate francais v3s15pier_wheel_f34e400f:
    ...
    pe "Je crois qu'elle est dans sa poche depuis plus de cinq secondes, Imre."

# game/v3/scene15.rpy:841
translate francais v3s15pier_wheel_b79ef743:

    # wa "All week so far!"
    wa "Depuis le début de la semaine !"
...
translate francais v3s15pier_wheel_4ef80381:
    ...
    u "À mon tour ! Allez, on va gagner gros..."
...
translate francais v3s15pier_wheel_6a6c1628:
    ...
    u "S'il vous plaît, sortez pas un vieux hot-dog de votre poche."
...
translate francais v3s15pier_wheel_95cecdd4:
    ...
    wa "Vous pouvez y aller maintenant."
...
translate francais v3s15pier_wheel_c79e6225:
    ...
    u "Hé, t'as refusé son bonbon de poche. Ce hot-dog est à moi !"
...
translate francais v3s15pier_wheel_6bed1659:
    ...
    u "Ce truc avec les yeux fonctionne pas avec moi."
...
translate francais v3s15pier_wheel_6487038c:
    ...
    u "Ok, c'est bon ! Arrête avec les larmes ! Pfff... *Soupirs*"
...
translate francais v3s15pier_wheel_57926778:
    ...
    wa "Je vais pas appeler la sécurité. Ça sera ça ton prix pour avoir détruit mon précieux souvenir."

# game/v3/scene15.rpy:1234
translate francais v3s15pier_wheel_927dd90f:

    # u "Damn, it's not like I did it on purpose."
    u "Putain, c'est pas comme si j'avais fait exprès."
...
translate francais v3s15pier_hotdog_a4544d21:
    ...
    imre "*Silencieusement* Elle est peut-être végane, mais plus tard elle va manger ma viande, héhéhé."

# game/v3/scene15.rpy:1310
translate francais v3s15pier_hotdog_a5c63c04:

    # u "With charm like that, man... How could she not?"
    u "Avec un tel charme... Comment est-ce qu'elle pourrait refuser ?"
...
translate francais v3s15pier_hotdog_721421ac:
    ...
    u "En tout cas, y a aucune chance qu'elle aille au-delà de la première base, aujourd'hui."

# game/v3/scene15.rpy:1326
translate francais v3s15pier_hotdog_f0933e1b:

    # imre "Where's your faith, man?"
    imre "Elle est où ta foi, mec ?"
...
translate francais v3s15pier_hotdog_f35ce279:
    ...
    hv "Ah, bonjour. Je vais maintenant vous émerveiller avec mes pouvoirs psychiques..."

# game/v3/scene15.rpy:1339
translate francais v3s15pier_hotdog_6a872125:

    # hv "You want a hotdog?"
    hv "Vous voulez un hotdog ?"
...
translate francais v3s15pier_hotdog_3a4027eb:
    ...
    hv "Et maintenant à votre sujet, je ressens une puissante envie d'un..."
...
translate francais v3s15pier_hotdog_b811d5d1:
    ...
    u "Est-ce qu'il y a autre chose au menu ? *Rire*"
...
translate francais v3s15pier_hotdog_394769c3:
    ...
    u "(Je pourrais être gentil, mais j'ai vraiment envie d'un hotdog gratuit.)"

# game/v3/scene15.rpy:1448
translate francais v3s15pier_hotdog_d51d3f52:

    # u "(Sue me.)"
    u "(Faites-moi un procès.)"

# game/v3/scene15.rpy:1458
translate francais v3s15pier_hotdog_3a4027eb_1:

    # hv "And now for you, I'm sensing a very powerful hunger for..."
    hv "Et maintenant pour vous, je ressens une très puissante faim de..."
...
translate francais v3s15pier_hotdog_d33cb5c3:
    ...
    imre "Un foyer végan ? Attends, les foyers ordinaires contiennent de la viande ?"
...
translate francais v3s15pier_hotdog_665d76da:
    ...
    dg3 "Non, Imre... Je voulais dire que mes parents étaient tous deux végans, alors j'ai été élevée de cette façon. La viande est tout simplement dégoûtante pour moi."
...
translate francais v3s15pier_hotdog_8ec7f984:
    ...
    imre "*Rire* Au fait, j'déconnais, je savais très bien c'que tu voulais dire."

# game/v3/scene15.rpy:1520
translate francais v3s15pier_hotdog_2d2e8c1f:

    # pe "You don't even like the smell of meat?"
    pe "Tu n'aimes même pas l'odeur de la viande ?"
...
translate francais v3s15pier_hotdog_0c52de84:
    ...
    u "Je te le dirai la prochaine fois que j'aurai envie de hot-dogs, on verra si je m'en sors. *Rire*"
...
translate francais v3s15pier_hotdog_b47d3496:
    ...
    dg3 "Tu ne dirais pas ça si tu savais quoi que ce soit sur l'industrie de la viande et la façon dont les animaux sont traités."
...
translate francais v3s15pier_hotdog_93137a0e:
    ...
    u "Peut-être pas mais manger des haricots et de la sauce toute ta vie doit être chiant, non ?"

# game/v3/scene15.rpy:1594
translate francais v3s15pier_hotdog_1decb99b:

    # dg3 "*Laughs* I love when people make that joke."
    dg3 "*Rire* J'adore quand les autres sortent cette vanne."
...
translate francais v3s15pier_hotdog_ae20c7cc:
    ...
    pe "Il existe des millions de recettes véganes, tout comme pour les aliments normaux."
...
translate francais v3s15pier_hotdog_059ba553:
    ...
    dg3 "Oui, surtout de nos jours, il y a beaucoup de restaurants végans qui ouvrent. Certains d'entre eux, tu ne pourrais même pas deviner qu'ils sont végans."
...
translate francais v3s15pier_hotdog_b827203b:
    ...
    imre "Tu sais pas c'que tu rates, Karen."
...
translate francais v3s15pier_hotdog_87113e05:
    ...
    pe "Sache que j'ai été primée à deux reprises en tant que compétitrice de mangeuse de hotdogs."

# game/v3/scene15.rpy:1726
translate francais v3s15pier_hotdog_b0a8b213:

    # u "*Chuckles* Are you being serious right now?"
    u "*Rire* T'es sérieuse là ?"
...
translate francais v3s15pier_hotdog_6cc792e8:
    ...
    u "Un jour, faudra que tu me racontes cette histoire."
...
translate francais v3s15pier_range_5fb9872b:
    ...
    u "(On devrait peut-être d'abord aller voir les autres attractions.)"
...
translate francais strings:
    ...
    new "C'est tout le contraire"

    # game/v3/scene15.rpy:1034
    old "Gentle spin"
    new "Tourne en douceur"

    # game/v3/scene15.rpy:1034
    old "Strong spin"
    new "Tourne très fort"

    # game/v3/scene15.rpy:1305
    old "How could she not?"
    new "Comment est-ce qu'elle pourrait pas ?"

    # game/v3/scene15.rpy:1305
    old "No way she does"
    new "Pas moyen qu'elle y arrive"

    # game/v3/scene15.rpy:1377
    old "Give her the coupon"
    new "Lui donner le coupon"

    # game/v3/scene15.rpy:1377
    old "Keep the coupon"
    new "Garder le coupon"

    # game/v3/scene15.rpy:1530
    old "Respect veganism"
    new "Respecte le véganisme"
