...
translate francais v3s60_66865102:
    ...
    li "[name] est ici pour prendre des notes à ma place, je ne veux rien manquer."

# game/v3/scene60.rpy:63
translate francais v3s60_2f767c95:

    # u "You've started the interview already?"
    u "T'as déjà commencé l'interview ?"
...
translate francais v3s60_856206c2:
    ...
    el "J'aime m'assurer que les gens soient détendus avant de commencer une interview."

# game/v3/scene60.rpy:78
translate francais v3s60_c1cafb4b:

    # li "Elijah just showed me the most ridiculous cat video."
    li "Elijah vient de me montrer une vidéo de chat vraiment ridicules."
...
translate francais v3s60_d26b22ad:
    ...
    li "Il y a un chat qui reste assis avec un oiseau sur la tête. Et un autre chat essaie d'attraper l'oiseau, mais il s'envole."

# game/v3/scene60.rpy:90
translate francais v3s60_a5e8adbc:

    # li "And then both cats fall into the fish pond. *Laughs* So stupid."
    li "Et les deux chats tombent dans l'étang à poissons. *Rire* C'est tellement ridicule."
...
translate francais v3s60_f2bd8c19:
    ...
    u "C'est pas grave. (Des vidéos de chats ? J'espère que c'est sa façon de faire de la lèche à la personne qu'il interview...)"
...
translate francais v3s60_e31e7504:
    ...
    el "Allez, commençons dès maintenant. Je préfère prendre des notes écrites. C'est moins perturbant."

# game/v3/scene60.rpy:110
translate francais v3s60_252a22b2:

    # li "A true professional. *Giggles*"
    li "Un vrai professionnel. *Ricane*"
...
translate francais v3s60_2e8be11d:
    ...
    li "Je crois pour débuter, qu'il est juste de dire que nous avons développé une rivalité, mais je considère toujours Chloé comme mon amie, et toujours comme ma sœur de sororité."
...
translate francais v3s60_6e2e67e8:
    ...
    li "Même avec tout le stress de la campagne, elle fait un travail incroyable. Elle n'abandonne jamais et je l'admire pour cette attitude."

# game/v3/scene60.rpy:152
translate francais v3s60_ab376e14:

    # u "(Vague compliments. I've trained her well, haha.)"
    u "(Vagues compliments. Je l'ai bien formé, haha.)"

# game/v3/scene60.rpy:157
translate francais v3s60_7f6e6eb4:

    # el "That's nice of you. Good answer."
    el "C'est gentil de ta part. Bonne réponse."
...
translate francais v3s60_e616da49:
    ...
    li "Merci. C'était une très bonne question. J'ai hâte de savoir ce que tu vas demander ensuite."
...
translate francais v3s60_6ce69f83:
    ...
    u "(Et elle garde le rythme, en contrôlant l'interview. Bien joué !)"
...
translate francais v3s60_d64e1422:
    ...
    li "Je sais que Chloé est superbe, n'est-ce pas ? Elle est superbe à regarder avec ses atouts... physiques."

# game/v3/scene60.rpy:183
translate francais v3s60_64fd78c0:

    # li "Oh, and she's good at volleyball."
    li "Oh, et elle est douée au volleyball."
...
translate francais v3s60_c4d592e2:
    ...
    li "Je considère qu'avoir des compétences relationnelles est une qualité très importante."
...
translate francais v3s60_d864418a:
    ...
    li "Sans un système de communication efficace, on ne peut pas résoudre les problèmes ou maintenir un environnement heureux."

# game/v3/scene60.rpy:219
translate francais v3s60_a7e8864f:

    # u "(Did she prepare that? Holy shit!)"
    u "(Elle a préparé tout ça ? Putain de merde !)"

# game/v3/scene60.rpy:224
translate francais v3s60_e4b6926a:

    # el "That was an excellent answer, Lindsey."
    el "Excellente réponse, Lindsey."
...
translate francais v3s60_d396d4b5:
    ...
    el "Ça serait sûrement l'idéal, mais je ne suis pas sûr que ça soit une qualité. Peux-tu être plus précise ?"

# game/v3/scene60.rpy:255
translate francais v3s60_ef90aa13:

    # li "Um... like... I don't know..."
    li "Hum... genre... Je ne sais pas..."
...
translate francais v3s60_b0a8a685:
    ...
    u "(Mais qu'est-ce qu'elle raconte ?)"
...
translate francais v3s60_95cc168f:
    ...
    el "Je pense qu'il est important que les gens sachent que tu es une bonne personne. Alors dis-moi, as-tu récemment fait quelque chose pour aider quelqu'un d'autre que toi ?"
...
translate francais v3s60_f42d6621:
    ...
    li "J'aime faire des dons à des œuvres de charité dès que possible. Depuis mon enfance, je fais ça."

# game/v3/scene60.rpy:324
translate francais v3s60_39f7eb4f:

    # el "Oh, what is your favorite charity?"
    el "Oh, as-tu une œuvre de charité pour laquelle tu as une préférence ?"
...
translate francais v3s60_3cea26d8:
    ...
    el "Et quel a été ton plus récent acte de charité ?"
...
translate francais v3s60_c3b67d5e:
    ...
    li "Oh, j'ai fait un don à l'association caritative locale pour les chiens ! Elle vient de rouvrir aujourd'hui, et ils ont besoin de tout le soutien qu'ils peuvent obtenir."
...
translate francais v3s60_81e77bb0:
    ...
    el "C'est très louable de ta part. J'y jetterai un coup d'œil plus tard."
...
translate francais v3s60_9538b1d9:
    ...
    el "Hum... Pas vraiment. Sauf si tu comptes le déplacement de pièces d'échecs comme de l'haltérophilie, haha."

# game/v3/scene60.rpy:460
translate francais v3s60_75d2408e:

    # li "Well... whatever you're doing, it's working."
    li "Eh bien... quoi que tu fasses, ça fonctionne."

# game/v3/scene60.rpy:462
translate francais v3s60_9f4c214f:

    # li "Let's grab a coffee sometime."
    li "On pourrait aller se prendre un café un de ces jours."
...
translate francais v3s60_57abfce3:
    ...
    u "(Et voilà le petit flirt que j'ai conseillé. Elle est douée. *Rire*)"
...
translate francais v3s60_f978108e:
    ...
    li "Merci encore, Elijah. J'ai vraiment hâte de lire cet article."

# game/v3/scene60.rpy:482
translate francais v3s60_8a773a4a:

    # el "I promise you, it's going to be great."
    el "Je te promets qu'il va être excellent."
...
translate francais v3s60_46dfff0a:
    ...
    ri "Bon, maintenant, passons aux choses sérieuses. Je voudrais vraiment avoir quelque chose de bon, pour la première édition."
...
translate francais v3s60_0be22e61:
    ...
    ri "Bien, voici une question intéressante. Qu'est-ce que tu admires chez ton adversaire présidentiel ?"

# game/v3/scene60.rpy:551
translate francais v3s60_fa945f0b:

    # u "(Keep it friendly, Linds.)"
    u "(Reste amicale, Linds.)"
...
translate francais v3s60_8f2f449a:
    ...
    li "Je dirais que Chloé est une excellente adversaire. Je la considère toujours comme mon amie, ma sœur de sororité."
...
translate francais v3s60_0a553980:
    ...
    li "Je l'admire pour le travail incroyable qu'elle fait, et ça ne doit pas être facile d'être mis au défi à la présidence, comme ça."
...
translate francais v3s60_a63f20e4:
    ...
    ri "C'est très gentil de t'entendre dire ça, Lindsey."

# game/v3/scene60.rpy:584
translate francais v3s60_3401ef2b:

    # li "Thanks, Riley. It was a great question, hehe."
    li "Merci, Riley. C'était une excellente question, héhé."
...
translate francais v3s60_b6cb09a2:
    ...
    li "Qu'est-ce que j'admire chez Chloé ? En tant que sa rivale, puis-je vraiment dire des choses gentilles sur elle et les penser ? *Rire*"

# game/v3/scene60.rpy:598
translate francais v3s60_12f25102:

    # ri "Why don't you try, you know, for the article?"
    ri "Pourquoi ne pas essayer, pour l'article ?"
...
translate francais v3s60_a82d69ea:
    ...
    li "Bon, c'est vrai qu'elle est vraiment canon. En fait, j'admire son physique, si je peux me permettre de dire ça."
...
translate francais v3s60_29da34fc:
    ...
    u "(Mince, j'aurais peut-être du la former davantage. Mais rétrospectivement, c'est 20/20 !)"
...
translate francais v3s60_82c2884c:
    ...
    ri "J'aimerais savoir s'il y a une qualité spécifique que, selon toi, toute présidente efficace devrait avoir ?"
...
translate francais v3s60_78db3c94:
    ...
    li "Il se peut qu'une personne soit préoccupée par une affaire sur le campus et qu'elle t'en parle."
...
translate francais v3s60_ac98623e:
    ...
    li "Lorsque tu interviens pour résoudre la question, ils se sentent écoutés et tu gagnes leur confiance."

# game/v3/scene60.rpy:657
translate francais v3s60_dfbe58e7:

    # ri "Wow, perfect. *Chuckles*"
    ri "Waouh, parfait. *Rire*"
...
translate francais v3s60_82dd4399:
    ...
    u "(Que dire ? Elle a eu un professeur incroyable, haha.)"
...
translate francais v3s60_af2fd870:
    ...
    ri "Excuse-moi de te dire ça, mais ça a l'air un peu général. Peux-tu préciser ? Comment faire pour que tout le monde soit heureux ?"
...
translate francais v3s60_a6749cc2:
    ...
    ri "C'est une très bonne idée, pour montrer aux gens ton côté gentil. As-tu fait quelque chose récemment pour aider quelqu'un d'autre que toi ?"
...
translate francais v3s60_c52c6380:
    ...
    li "Depuis que je suis toute petite, j'ai toujours fait des dons à des œuvres caritatives. Je donnais mon argent de poche à des œuvres telles que la sauvegarde de la forêt tropicale."

# game/v3/scene60.rpy:727
translate francais v3s60_31d86a64:

    # ri "Aw, that's so cute."
    ri "Ooh, c'est trop mignon."
...
translate francais v3s60_493d4d41:
    ...
    li "J'ai fait un don à l'association caritative locale pour les chiens. Je me sens si triste quand je vois tous les chiens qui y sont, qui ont été abandonnés, alors je fais des dons dès que possible."
...
translate francais v3s60_a324e253:
    ...
    li "Je ne suis pas une grande fan des chats. Ils sont trop... prétentieux...? Ha. Ils ne se soucient pas de leurs propriétaires comme le font les chiens."
...
translate francais v3s60_7bede76e:
    ...
    ri "Je les ai côtoyés toute ma vie et je peux dire qu'ils font partie des créatures les plus intelligentes de la planète."
...
translate francais v3s60_5d4503af:
    ...
    u "(Bon, Lindsey vient de réussir à insulter Riley, sa mère et les chats de sa mère. Merde.)"
...
translate francais v3s60_c3abf6a6:
    ...
    ri "Bon, je crois que c'est bien assez pour l'article. Merci pour l'interview, Lindsey."

# game/v3/scene60.rpy:826
translate francais v3s60_f84b2164:

    # li "Thanks, Riley. It was fun."
    li "Merci, Riley. C'était amusant."
...
translate francais v3s60_1d4034c3:
    ...
    ri "Très professionnel avec la poignée de main, héhé. J'aime ça !"
...
translate francais v3s60_d2d966c3:
    ...
    li "Oh, et tu vas devoir me dire quel produit tu utilises pour tes cheveux. Ils sont resplendissant aujourd'hui !"
...
translate francais v3s60_a306be90:
    ...
    li "Oh, en tout cas, j'adore ça. Il faudra qu'on se voit un jour pour se prendre un café, tu pourras peut-être me donner quelques conseils ?"
...
translate francais v3s60_ba862ea1:
    ...
    u "(Double perf' ! Garder le côté professionnel et insérer des compliments. Je suis heureux qu'elle ait écouté mes conseils.)"
...
translate francais v3s60_c78cacf2:
    ...
    u "Mais on verra bien ce qu'il en est de l'article lui-même. On lui fait vraiment confiance."
...
translate francais v3s60_27a8e978:
    ...
    li "Maintenant que c'est fait, on va voir le résultat."
...
translate francais v3s60_d9f36350:
    ...
    li "Merci d'avoir été là pour moi."
...
# game/v3/scene60.rpy:346
translate francais v3s60_73cd9d65:
