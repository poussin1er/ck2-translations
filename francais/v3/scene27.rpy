...
translate francais v3s27_7484e1da:
    ...
    lee "Ok, chers élèves. Installez-vous s'il vous plaît."
...
translate francais v3s27_63bbe4a8:
    ...
    lee "Non, ce n'est pas une conférence de dix heures. Je sais bien que vous ne pourrez supporter tant d'excitation."
...
translate francais v3s27_fb904121:
    ...
    lee "En revanche, vous apprendrez tous à vous occuper d'un bébé !"
...
translate francais v3s27_79cb4436:
    ...
    pe "Mr Lee ? Je ne veux pas être impolie, mais qu'est-ce que ça a à voir avec l'histoire ?"

# game/v3/scene27.rpy:43
translate francais v3s27_0139eeab:

    # lee "That's a great question, Penelope!"
    lee "C'est une très bonne question, Pénélope !"
...
translate francais v3s27_337245da:
    ...
    lee "La première chose que vous devrez faire avant de devenir parent sera de choisir un partenaire. Une décision à ne pas prendre à la légère."

# game/v3/scene27.rpy:50
translate francais v3s27_d5cd8124:

    # u "(So, he's just not going to tell us or...?)"
    u "(Il va pas répondre à la question ou... ?)"

# game/v3/scene27.rpy:55
translate francais v3s27_b96a5ec1:

    # lee "Choose wisely!"
    lee "Choisissez judicieusement !"
...
translate francais v3s27_8eb6b0e6:
    ...
    u "(On dirait que la plupart des autres ont déjà choisi leur partenaire ! Je dois me dépêcher avant que tout le monde soit pris !)"
...
translate francais v3s27_9a9e47ad:
    ...
    no "Oui. Je serais ta femme pour ce cours, haha."
...
translate francais v3s27_126eda30:
    ...
    no "Mais pas de conneries. J'ai vraiment envie d'apprendre à être une bonne mère."
...
translate francais v3s27_8306a027:
    ...
    u "(Super. J'étais sûr qu'elle serait à fond dedans.)"
...
translate francais v3s27_choose_chloe_parent_cbf3ed9f:
    ...
    cl "Ben, on doit jouer avec des poupées de bébé. *Rires moqueurs*"
...
translate francais v3s27_choose_chloe_parent_738691eb:
    ...
    u "Si tu le dis. Tu changeras peut-être d'avis un jour ?"
...
translate francais v3s27_choose_chloe_parent_ed25bc16:
    ...
    cl "C'est possible, mais je verrai ça plus tard."
...
translate francais v3s27_choose_chloe_parent_81fa55f5:
    ...
    u "(Elle sera peut-être plus intéressée lorsqu'on saura exactement quoi faire.)"
...
translate francais v3s27_continue_after_parent_choice_e8f3b98d:
    ...
    sexed "Bonjour, à vous. J'aimerais que tout le monde regarde ce bébé."
...
translate francais v3s27_continue_after_parent_choice_cad01620:
    ...
    u "(Comment est-on censé s'occuper d'une poupée ?)"
...
translate francais v3s27_continue_after_parent_choice_9f6869a8:
    ...
    sexed "Maintenant, passons les règles en revue."
...
translate francais v3s27_continue_after_parent_choice_0f117113:
    ...
    sexed "Si votre bébé est contrarié pour une raison quelconque, il va pleurer. Mais heureusement pour vous, chaque bébé est accompagné d'un trousseau de clés."
...
translate francais v3s27_continue_after_parent_choice_301cf74c:
    ...
    sexed "Utilisez la bonne clé et les pleurs s'arrêteront. La clé bleue sert à le nourrir. La clé verte sert à lui faire faire son rot. La clé orange sert à changer sa couche."
...
translate francais v3s27_continue_after_parent_choice_399804e0:
    ...
    sexed "Il suffit de mettre la bonne clé sur la bouche du bébé pour le nourrir ou lui faire faire son rot."
...
translate francais v3s27_continue_after_parent_choice_d8cb2ee5:
    ...
    sexed "Ou encore, pour changer la couche, il suffit de poser la bonne clé sur le bas du dos du bébé."
...
translate francais v3s27_continue_after_parent_choice_25cc6718:
    ...
    sexed "Le capteur à l'intérieur détectera si vous avez utilisé la bonne ou non."
...
translate francais v3s27_continue_after_parent_choice_e1fd7f2a:
    ...
    cl "Ouais, ouais. Taper dessus avec la clé pour qu'il arrête de pleurer. Pas besoin d'être un génie, [name]."
...
translate francais v3s27_continue_after_parent_choice_f078f5cc:
    ...
    cl "*Rire moqueur* Ne sois pas si sérieux. Il n'y a pas de quoi s'inquiéter. Rien de plus simple !"
...
translate francais v3s27_continue_after_parent_choice_07f531f8:
    ...
    u "(Elle veut visiblement pas le faire et j'ai pas envie de me lancer dans un débat.)"
...
translate francais v3s27_continue_after_parent_choice_33f2edc6:
    ...
    u "(Est-ce que je dois vérifier si Nora a bien tout compris ?)"
...
translate francais v3s27_continue_after_parent_choice_af6aabb1:
    ...
    u "(Je crois que ça répond à ma question...)"
...
translate francais v3s27_continue_after_parent_choice_7e2bd5c1:
    ...
    u "(Nan, on dirait qu'elle absorbe toutes les infos. Elle fera une super maman de faux bébé, héhé.)"
...
translate francais v3s27_continue_after_parent_choice_aa1ea8b2:
    ...
    sexed "C'est très simple. Une fois que vous aurez passé un peu de temps avec votre bébé, vous commencerez à comprendre ses besoins."
...
translate francais v3s27_continue_after_parent_choice_7714eeeb:
    ...
    sexed "Comme dans la vie réelle, les bébés pleureront lorsque vous essayez de dormir."
...
translate francais v3s27_continue_after_parent_choice_7566ee56:
    ...
    sexed "Par conséquent, ces bébés nocturnes, comme on les appelle, seront actifs de vingt-deux heures à dix heures du matin."

# game/v3/scene27.rpy:342
translate francais v3s27_continue_after_parent_choice_015463d9:

    # u "(Seriously? Goodbye sleep! *Sighs*)"
    u "(Sérieux ? Adieu le sommeil ! *Soupirs*)"
...
translate francais v3s27_continue_after_parent_choice_79389e7f:
    ...
    sexed "En tant que partenaires, chacun d'entre vous passera une nuit seul avec le bébé ainsi qu'une nuit ensemble."
...
translate francais v3s27_continue_after_parent_choice_76ede55c:
    ...
    sexed "Oh, et une dernière chose. N'hésitez pas à donner à votre bébé le nom que vous voulez."
...
translate francais v3s27_continue_after_parent_choice_17ec16e0:
    ...
    cl "En fait, je m'en fous, [name]. T'as qu'à choisir un truc."
...
translate francais v3s27_continue_after_parent_choice_c7f842ed:
    ...
    u "Bien, bébé Plastique. J'espère que tu aimes ton nouveau nom."
...
translate francais v3s27_continue_after_parent_choice_6412d97c:
    ...
    cl "*Soupirs* pas sûre qu'il ait un avis quelconque."
...
translate francais v3s27_continue_after_parent_choice_67dd64fc:
    ...
    u "À quoi tu penses ? Nora junior ? *Rire*"
...
translate francais v3s27_continue_after_parent_choice_cff99a5d:
    ...
    no "Haha, non ! Allez, on va trouver quelque chose de mignon, comme Henry ou..."
...
translate francais v3s27_continue_after_parent_choice_79af798d:
    ...
    u "Hmm, alors, avons-nous un garçon ou une fille ?"
...
translate francais v3s27_continue_after_parent_choice_4b3b255d:
    ...
    u "Ha, d'accord. (La laisser choisir, ou suggérer autre chose ?)"
...
translate francais v3s27_continue_after_parent_choice_74458439:
    ...
    cl "*Soupirs* C'est enfin terminé. Maintenant, on peut reprendre une vie normale."
...
translate francais v3s27_continue_after_parent_choice_cb7032b7:
    ...
    u "Écoute, je vois bien que t'es pas très enthousiaste à ce sujet. Mais est-ce qu'on peut au moins essayer ? J'ai pas vraiment envie de rater ce truc."
...
translate francais v3s27_continue_after_parent_choice_086ac841:
    ...
    u "Chloé, c'est un projet de groupe. On est là pour avoir une éducation à la fin de la journée. On peut prioriser ça pendant une seconde ?"
...
translate francais v3s27_continue_after_parent_choice_d0ae2a2b:
    ...
    cl "Comme je l'ai dit, ça sera pas noté, [name]. C'est juste une stupide poupée bébé pour laquelle ils veulent qu'on se prive de sommeil."
...
translate francais v3s27_continue_after_parent_choice_9461848f:
    ...
    u "Alors privons nous de sommeil ! C'est censé être une expérience, et je t'ai choisi comme partenaire parce que je me suis dit que ça serait amusant."
...
translate francais v3s27_continue_after_parent_choice_73ec6023:
    ...
    cl "Bon, par contre, je ne vais pas faire comme si j'avais réellement accouché de cette chose."
...
translate francais v3s27_continue_after_parent_choice_c346ebac:
    ...
    cl "Si tu voulais quelqu'un qui allait agir comme une \"maman\", tu aurais dû faire équipe avec Nora."
...
translate francais v3s27_continue_after_parent_choice_31990c12:
    ...
    cl "Je suis sûre qu'elle se réveillerait volontiers à 3 heures du mat' pour faire roter ce truc débile."
...
translate francais v3s27_continue_after_parent_choice_2dc88ffa:
    ...
    u "Ok, je te demande pas de jouer au papa et à la maman avec moi, Chloé. Essayons juste d'y arriver."
...
translate francais v3s27_continue_after_parent_choice_2000f9a1:
    ...
    u "(J'ai déjà l'impression d'être un père célibataire, là.)"
...
translate francais v3s27_continue_after_parent_choice_185d1d60:
    ...
    no "Youpi ! En fait, j'ai hâte de m'y mettre, haha."
...
translate francais v3s27_continue_after_parent_choice_cca81922:
    ...
    u "Ça sera un vrai test pour savoir si plus tard, tu voudras des enfants ou non."
...
translate francais v3s27_continue_after_parent_choice_801a5cfe:
    ...
    no "Oh, je sais déjà que j'en veux. Je sais pas encore combien, par contre."
...
translate francais v3s27_continue_after_parent_choice_8731d3e3:
    ...
    no "Peu importe comment se déroule ce projet, j'aurai toujours envie d'être maman, un jour."
...
translate francais v3s27_continue_after_parent_choice_5f7ec996:
    ...
    no "Mais est-ce que tu peux me le reprocher ? Je n'ai fait que réfléchir, admettre et m'améliorer ces dernières semaines. J'ai compris beaucoup de choses."
...
translate francais v3s27_continue_after_parent_choice_c3a9246f:
    ...
    u "C'est super, et je suis content pour toi, mais on va voir comment tu te débrouilles à 4 heures du matin quand [v3_baby_name] aura besoin qu'on change sa couche. *Rire*"
...
translate francais v3s27_continue_after_parent_choice_7148e72b:
    ...
    no "Haha, je ferai ça avec le sourire ! Je parie que Chloé va s'arracher les cheveux à l'autre bout du couloir, mais moi, je suis excitée."
...
translate francais v3s27_continue_after_parent_choice_0c311b43:
    ...
    u "(Maintenant, j'en suis sûr. On devrait réussir sans problème.)"
...
translate francais v3s27_continue_after_parent_choice_17daf358:
    ...
    li "Hé, ne crois pas que tu vas t'échapper maintenant ! Haha, il faut qu'on aille planifier la phase trois de ma campagne !"
...
translate francais strings:
    ...
    old "Plastic it is"
    new "Ça sera Plastique"

    # game/v3/scene27.rpy:401
    old "A different name"
    new "Un nom différent"
