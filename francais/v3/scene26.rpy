...
translate francais v3s26_da3df64f:
    ...
    li "Haha, je t'ai fait sursauter ?"
...
translate francais v3s26_43e4af76:
    ...
    li "Hmm... on dirait tout de même que tu as un peu sursauté. *Rire*"

# game/v3/scene26.rpy:47
translate francais v3s26_fcb60f55:

    # u "No way. I'm unjumpable."
    u "Pas du tout. Je suis insursautable."
...
translate francais v3s26_8a12a0ce:
    ...
    li "Cette punition est la plus bizarre de toutes. Il joue même de la musique méditative pendant qu'on fait ça."
...
translate francais v3s26_05744770:
    ...
    li "C'est pas drôle ! Il nous lit aussi des citations d'un livre sur la réflexion positive et l'importance du respect. Argh..."

# game/v3/scene26.rpy:107
translate francais v3s26_8d9c45d2:

    # u "Classic Mr. Lee, the man is an actual character."
    u "Un classique de Mr Lee, ce mec est un vrai personnage."

# game/v3/scene26.rpy:112
translate francais v3s26_1c69f24d:

    # li "*Sighs* Anyway, enough about that."
    li "*Soupirs* Bref, assez parlé de ça."
...
translate francais v3s26_85f36c84:
    ...
    u "Oh, ouais ! C'était super. J'ai hâte d'y retourner et de voir comment vont les petits."
...
translate francais v3s26_1683badf:
    ...
    u "Ah, oui ! Autumn est géniale. Elle prend vraiment soin des animaux et franchement, elle est bien plus cool que je le pensais, haha."
...
translate francais v3s26_244ee5cb:
    ...
    li "Je sais ! Depuis qu'on a traîné ensemble l'autre soir, je l'adore. Elle est tellement cool."
...
translate francais v3s26_3a945922:
    ...
    li "Je voulais vraiment assister à la réouverture, mais j'avais pas le temps ce jour-là..."
...
translate francais v3s26_59188b8a:
    ...
    li "Est-ce que tu pourrais prendre ce don pour moi et t'assurer qu'il arrive entre de bonnes mains ?"
...
translate francais v3s26_a2eafcaa:
    ...
    li "Merci. Ça devrait pouvoir aider quelques bébés à fourrure."
...
translate francais v3s26_25cc9854:
    ...
    u "Haha, je suis sûr qu'ils vont aimer ça. Je le donnerai à Autumn dès que je la verrai."
...
translate francais v3s26_2bf1b33a:
    ...
    pe "Ok, alors, devinez qui va venir, grâce à moi, donner un petit concert pour nous demain soir ?"

# game/v3/scene26.rpy:208
translate francais v3s26_b591764f:

    # u "The music majors?"
    u "Les étudiants en musique ?"
...
translate francais v3s26_0c9f23c7:
    ...
    pe "Elle nous a vraiment aimé pour une raison inconnue, et on est devenus ses meilleurs amis, en gros... *Rire* La soirée la plus folle de ma vie."

# game/v3/scene26.rpy:301
translate francais v3s26_cd7094f6:

    # u "Don't act all humble now. You're the one she liked."
    u "Fais pas ta modeste, là. C'est TOI qu'elle a aimé."

# game/v3/scene26.rpy:306
translate francais v3s26_ae3bb29e:

    # li "I'm so fucking jealous."
    li "Je suis si jalouse."
...
translate francais v3s26_9692c9f4:
    ...
    pe "Elle a récemment organisé une séance où elle signait des autographes et faisait la promotion de son nouveau single."
...
translate francais v3s26_84d89b6b:
    ...
    pe "On s'est tout de suite bien entendues, je ne sais même pas comment l'expliquer. Elle a dit qu'on était comme des sœurs perdues depuis longtemps ou un truc comme ça, haha !"

# game/v3/scene26.rpy:330
translate francais v3s26_f2793ee4:

    # u "(Polly's in town? Huh. I wonder if she'd recognize me?)"
    u "(Polly est en ville ? Hum. Je me demande si elle me reconnaîtrait !?)"

# game/v3/scene26.rpy:335
translate francais v3s26_419b141d:

    # li "Oh my god, you're living my actual dream!"
    li "Oh mon Dieu, tu es en train de vivre mon rêve idéal !"
...
translate francais v3s26_c3c41d0f:
    ...
    pe "Haha, je me suis mise en relation avec elle sur Kiwii et on a parlé de la SVC."
...
translate francais v3s26_15cc9d48:
    ...
    pe "Elle n'aura le temps de chanter que quelques chansons, mais elle va vraiment venir dans notre université !"
...
translate francais v3s26_c9138022:
    ...
    pe "Elle n'en avait pas. Ce mec lui a seulement dit qu'elle était sexy et lui a demandé de l'embrasser."
...
translate francais v3s26_586491a2:
    ...
    pe "Haha, ouais. J'imagine que ça fonctionne sur certaines personnes. Ils auront un rencard la semaine prochaine."

# game/v3/scene26.rpy:422
translate francais v3s26_d9e040ee:

    # u "Yikes, it sucks for Imre."
    u "Putain, ça craint pour Imre."
...
translate francais v3s26_248e22f3:
    ...
    li "Ouais, mais si t'es avec la mauvaise personne, ton cœur continuera à chercher la bonne."

# game/v3/scene26.rpy:432
translate francais v3s26_b05d273b:

    # u "Wow. Very wisdomous today."
    u "Waouh. T'es très sagicieuse, aujourd'hui."

# game/v3/scene26.rpy:437
translate francais v3s26_063ab0b9:

    # li "Again, I don't think that's a word..."
    li "Une fois encore, je ne suis pas sûre que ce mot existe..."
...
translate francais v3s26_c796af13:
    ...
    pe "Mais il a raison. C'était une phrase bien pensée, je suis fière de toi. *Ricane*"
...
translate francais v3s26_ae401300:
    ...
    pe "On devrait peut-être aller en classe, maintenant."
...
translate francais v3s26_eddc69fe:
    ...
    li "Ah, oui ! C'est ça que j'étais censé vous dire, haha !"
...
translate francais v3s26_7beec2a1:
    ...
    pe "Wouah. Eh bien, allons découvrir ça, ok ? *Rire*"
...
translate francais strings:
    ...
    old "Yeah, it's great"
    new "Ouais, c'est super"

    # game/v3/scene26.rpy:116
    old "Yeah, she's great"
    new "Ouais, elle est géniale"

    # game/v3/scene26.rpy:203
    old "The music majors"
    new "Les étudiants en musique"
