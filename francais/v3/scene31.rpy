...
translate francais v3s31_a8f96ec8:
    ...
    gr "T'sais quoi ? Ce petit accord pour que tu vives ici !? Ça doit finir."

# game/v3/scene31.rpy:76
translate francais v3s31_ff7abe37:

    # gr "You're not an Ape. You shouldn't be here."
    gr "T'es pas une Ape. T'as rien à foutre là."
...
translate francais v3s31_28ef11c4:
    ...
    sa "Dis ça à mon frère, abruti. J'ai pas envie d'rester là plus longtemps !"
...
translate francais v3s31_f95fccd1:
    ...
    u "Sam, je vois bien où Grayson veut en venir. Peu de fraternités ont des filles qui vivent sur leur canapé."

# game/v3/scene31.rpy:136
translate francais v3s31_b602be72:

    # sa "Well, fuck you too, then."
    sa "Eh ben alors, toi aussi, va t'faire foutre."

# game/v3/scene31.rpy:141
translate francais v3s31_f4324f99:

    # gr "*Scoffs* Do you see what I have to deal with?"
    gr "*Rire moqueur* Tu vois à quoi j'dois faire face ?"
...
translate francais v3s31_469474c2:
    ...
    sa "Comme j'ai dit, parle-en à Cameron !"
...
translate francais v3s31_9dfc6243:
    ...
    u "Je sais que c'est difficile, je peux comprendre. Mais c'est la sœur de Cameron. Et en aidant Sam, on aide l'un des Apes."
...
translate francais v3s31_fa41a964:
    ...
    gr "On dirait que t'as regardé trop de talk-shows, [name]."
...
translate francais v3s31_76379e0c:
    ...
    sa "*Chuchote* Je crois qu'il est en colère parce qu'il veut me baiser. C'est tout."

# game/v3/scene31.rpy:204
translate francais v3s31_47737368:

    # gr "I wouldn't even touch you with someone else's dick!"
    gr "J'te toucherais même pas avec la bite d'un autre !"
...
translate francais v3s31_d0e7ed67:
    ...
    sa "OK, j'ai reçu l'message. Merci de l'avoir dit si délicatement ! Tête de noeud."
...
translate francais v3s31_cef97370:
    ...
    gr "Haha, parfait ! Ça rentre enfin dans ta sale petite tête !"

# game/v3/scene31.rpy:220
translate francais v3s31_f36331b9:

    # gr "Now, I'm done with this conversation."
    gr "J'en ai marre de cette conversation."
...
translate francais v3s31_dd4439d5:
    ...
    gr "Je vais acheter des bougies, au cas où cette panne de courant recommence."
...
translate francais v3s31_9a6343c2:
    ...
    sa "J'vais sortir et voir ce que font les autres. On s'voit plus tard, [name]."

# game/v3/scene31.rpy:276
translate francais v3s31_1ca3846e:

    # u "Yeah, okay. Later, Sam."
    u "Ouais, d'accord. À plus, Sam."
...
translate francais v3s31_0ce8694f:
    ...
    sa "Oh, et mes souvenirs de nous en train de baiser... ils commencent à disparaître. Va falloir les rafraîchir très vite."
...
translate francais v3s31_1bc20b69:
    ...
    u "(Je vais aller dans ma chambre...)"

translate francais strings:

    # game/v3/scene31.rpy:125
    old "Agree with Grayson"
    new "Être d'accord avec Grayson"
