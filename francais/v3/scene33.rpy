...
translate francais v3s33_c5d23652:
    ...
    u "*Rire* (Je devrais peut-être suivre un cursus en art.)"
...
translate francais v3s33_f184b84f:
    ...
    # u "(Ah... Nice and fresh.)"
    u "(Ah... Agréable et rafraîchissant.)"
...
translate francais v3s33_phone_continue2_62f4ee4d:
    ...
    u "(Il ressemble plus à un Chihuahua, haha)."

translate francais strings:

    # game/v3/scene33.rpy:17
    old "Draw a cat"
    new "Dessiner un chat"
...
translate francais v3s33_e34111fe:
    ...
    u "(Je devrais peut-être suivre un cursus en art.)"
...
translate francais v3s33_phone_continue2_202b0eb5:
    ...
    u "(Il ressemble plus à un Chihuahua.)"
