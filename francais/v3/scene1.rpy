...
translate francais v3s1_lose_9d7f2dca:
    ...
    u "Il a juste eu quelques frappes chanceuses, c'est tout."
...
translate francais v3s1_lose_cd8a736e:
    ...
    ri "Tom est dingue ! Il est sorti de nulle part et a commencé à demander des choses à propos de Charli, et-"

# game/v3/scene1.rpy:513
translate francais v3s1_lose_8041bf95:

    # u "I know, I heard."
    u "Je sais, j'ai entendu."
...
translate francais v3s1_lose_7da27121:
    ...
    u "Ouais. *Grogne* Je suis simplement très fatigué, et j'ai mal partout. Je suis vraiment impatiente de rentrer à la maison."

# game/v3/scene1.rpy:533
translate francais v3s1_lose_ce336452:

    # ri "I'm sure you are, but you're not going home."
    ri "Je suis sûre que c'est le cas, mais tu ne vas pas rentrer chez toi."
...
translate francais v3s1_lose_dbcc7f13:
    ...
    ri "Tu vas rentrer avec moi. Je veux garder un œil sur toi."
...
translate francais v3s1_lose_e52cd607:
    ...
    u "Je vais seulement aller me coucher. T'as pas l'intention de rester à me regarder dormir, si ?"
...
translate francais v3s1_lose_fa305021:
    ...
    ri "Je dois rechercher les signes d'une commotion cérébrale, m'assurer que tu te réveilles le matin, des choses comme ça."
...
translate francais v3s1_lose_3581b918:
    ...
    ri "[name]... Qui sait les blessures que tu as ?!"
...
translate francais v3s1_lose_43399c6f:
    ...
    ri "Ça pourrait ne rien être, ça pourrait être quelque chose. Laisse-moi seulement prendre soin de toi."
...
translate francais v3s1_lose_9448d8c3:
    ...
    u "(Hmm... Je serais pas contre un peu d'attention. Mais là encore, je suis pas sûr d'être d'humeur pour autre chose que mon oreiller et une couverture.)"
...
translate francais v3s1_lose_a72135ca:
    ...
    u "Franchement, j'ai juste envie de rentrer chez moi et de m'écrouler dans mon propre lit. Je suis crevé."
...
translate francais v3s1_lose_bc851948:
    ...
    ri "*Soupir* Tu es sûr ? Je pourrais te préparer une tasse de thé et trouver un bon paquet de petits pois congelés."

# game/v3/scene1.rpy:611
translate francais v3s1_lose_e2e0223a:

    # u "Haha, thanks for the offer, but no. Sorry."
    u "Haha, merci pour l'offre, mais non. Désolé."
...
translate francais v3s1_lose_0697d369:
    ...
    ri "Veille à bien te reposer et envoie-moi des nouvelles quand tu te sentiras mieux, d'accord ?"

# game/v3/scene1.rpy:626
translate francais v3s1_lose_6b707209:

    # u "Okay, I will. Thank-"
    u "D'accord, je le ferai. Merci-"

# game/v3/scene1.rpy:631
translate francais v3s1_lose_499a4e13:

    # ri "Stop thanking people when you're the hero."
    ri "Arrête de remercier les autres quand c'est toi le héros."
...
translate francais v3s1_lose_52cabd07:
    ...
    ri "Mmhmm. Je pourrais peut-être même te trouver un pansement rose. Tu aimerais ça, princesse ?"
...
translate francais v3s1_win_7aeee03b:
    ...
    ri "J'ai été inquiète pour toi, pendant un instant. Mais de toute évidence, je n'avais pas besoin de l'être."
...
translate francais v3s1_win_3b01a219:
    ...
    ri "Je ne sais pas ce qui me serait arrivé si tu n'étais pas apparu à ce moment-là."
...
translate francais v3s1_win_e96966a3:
    ...
    u "Ouais, on a eu de la chance. J'étais tout simplement au bon endroit au bon moment."
...
translate francais v3s1_win_c63f6c42:
    ...
    u "J'ai entendu tes cris, et j'allais pas laisser ce connard poser un doigt sur toi."

# game/v3/scene1.rpy:797
translate francais v3s1_win_7dd02875:

    # u "You can always count on me, Riley."
    u "Tu peux toujours compter sur moi, Riley."
...
translate francais v3s1_win_25064fb6:
    ...
    u "Il te fera plus chier, mais s'il tente quoique ce soit, préviens-moi, d'accord ?"
...
translate francais v3s1_win_55c6ff61:
    ...
    ri "Ouais, je sais. C'est juste que je n'ai jamais été menacée comme ça auparavant, tu vois ?"

# game/v3/scene1.rpy:829
translate francais v3s1_win_9505f2c4:

    # ri "I just don't feel safe going home alone right now."
    ri "Je ne suis pas très rassurée, à l'idée de rentrer seule à la maison pour l'instant."
...
translate francais v3s1_win_9b0d9d3a:
    ...
    u "Toujours à ton service, Riley. Passe une bonne nuit."
...
translate francais v3s1_win_7f2a7632:
    ...
    u "Bien sûr. Je peux pas te laisser rentrer seule à la maison dans le noir, surtout si tu te sens pas en sécurité."
...
translate francais v3s1_win_5bbe4e42:
    ...
    u "T'inquiète pas, je suis sûr qu'on va bien s'amuser."

# game/v3/scene1.rpy:923
translate francais v3s1_win_4c98ac93:

    # ri "Oh, we will... *Chuckles*"
    ri "Oh oui, on va s'amuser... *Rire*"
...
translate francais strings:
    ...
    new "Ça fait très mal"

    # game/v3/scene1.rpy:599
    old "Go home alone"
    new "Rentre à la maison seul"

    # game/v3/scene1.rpy:599
    old "Go home with Riley"
    new "Rentre à la maison avec Riley"

    # game/v3/scene1.rpy:779
    old "We got lucky"
    new "On a eu de la chance"
