...
translate francais recap_end_b06b3ceb:
    ...
    u "On a appris que Lindsey avait décidé de se présenter contre Chloé pour être présidente de la sororité des Chicks."

# game/recap/recap03.rpy:53
translate francais recap_end_2ac32ff3:

    # u "The tension was clearly building between her and Chloe."
    u "La tension était clairement en train de monter entre elle et Chloé."

# game/recap/recap03.rpy:63
translate francais recap_end_c9a0c89d:

    # u "Pretty soon, I was going to be expected to pick a side, or..."
    u "Bientôt, on attendrait de moi que je choisisse un camp, ou..."
...
translate francais recap_end_a06cc4a4:
    ...
    u "Il me faudrait être très malin à propos de la façon dont je déciderai de jouer ce rôle."
...
translate francais recap_end_d3f3446f:
    ...
    u "Il y a également eu l'occasion de voir la chanteuse internationale, la superstar Polly, en concert."
...
translate francais recap_end_ce6b76cc:
    ...
    u "Puis notre voyage en Europe s'étant terminé, il était temps de reprendre l'avion et de rentrer au pays. Tout s'est passé si vite, mais c'est une expérience que je n'oublierai jamais !"
