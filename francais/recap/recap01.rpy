...
translate francais recap_start_84ee90c4:
    ...
    narrator "C'était moi lors de mon premier jour à l'université San Vallejo."
...
translate francais recap_start_04f5f176:
    ...
    narrator "Le petit nouveau du campus qui n'avait aucune idée du style de vie tumultueux dans lequel je me lançais."

# game/recap/recap01.rpy:30
translate francais recap_start_fcf1fcd2:

    # narrator "All the girls..."
    narrator "Toutes les filles..."
...
translate francais test_rep_screen_602d8c8f:
    ...
    u "Il n'est pas aussi sûr de lui qu'Imre, mais c'est un allier solide et un ami loyal."

# game/recap/recap01.rpy:100
translate francais test_rep_screen_118ffe31:

    # u "And there were the girls of course."
    u "Et il y avait les filles, évidemment."
...
translate francais test_rep_screen_34071af0:
    ...
    u "Mais il n'allait pas tarder à y avoir de nombreuses autres filles qui allaient entrer dans ma vie..."
...
translate francais test_rep_screen_3b34470e:
    ...
    u "avec autant de choix quant à savoir avec qui je souhaitais entretenir une relation ou tout simplement rester ami."
...
translate francais test_rep_screen_58a71383:
    ...
    u "Ce qui a conduit à la première grande décision que j'ai dû prendre et qui allait façonner tout mon avenir."
...
translate francais test_rep_screen_c3d63b2b:
    ...
    u "Quelle fraternité je voulais rejoindre ? Les Wolves ou les Apes ?"
...
translate francais test_frat_selection_f8396888:
    ...
    u "J'ai réussi mon intégration en montrant ma loyauté envers la fraternité et mes nouveaux frères..."

# game/recap/recap01.rpy:215
translate francais test_frat_selection_214224ac:

    # u "and moved into the frat house."
    u "et emménagé dans la maison de la fraternité."
...
translate francais test_frat_selection_2a81a40e:
    ...
    u "Il m'était possible de draguer plusieurs filles à la fois..."
...
translate francais test_frat_selection_4340bb3f:
    ...
    u "mais c'est devenu assez compliqué quand il a fallu n'en retenir qu'une..."
...
translate francais test_frat_selection_a0724e31:
    ...
    u "ce qui voulait dire en partie, que je ne pouvais plus aller voir ailleurs, car..."

# game/recap/recap01.rpy:291
translate francais test_frat_selection_1ec44789:

    # u "they were best friends..."
    u "elles étaient meilleures amies..."
